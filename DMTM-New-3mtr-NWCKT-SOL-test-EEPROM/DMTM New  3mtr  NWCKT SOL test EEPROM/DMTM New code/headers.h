...
#define INT_ENCODERFRONTA_VECT	INT5_vect
#define ENCODERFRONTB	C,1


#define INT_ENCODERBACKA_VECT	INT4_vect
#define ENCODERBACKB	C,3
...
#define SIDEMOTOR_INT		INT1
#define SIDEMOTOR_INTPIN	D,1
#define SIDEMOTOR_ISC0		ISC10
#define SIDEMOTOR_ISC1		ISC11
#define SIDEMOTOR_INTF		INTF1
#define SIDEMOTOR_INT_vect	INT1_vect
