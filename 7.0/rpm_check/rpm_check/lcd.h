...
#define LCD_EN_PIN	PIND6
	
#define	LCD_RS_PORT PORTD		//R/S line
#define	LCD_RS_PIN	PIND7

#define LCD_D7_PORT PORTD
#define LCD_D7_PIN	PIND2
#define LCD_D6_PORT PORTD
#define LCD_D6_PIN	PIND3
#define LCD_D5_PORT PORTD
#define LCD_D5_PIN	PIND4
#define LCD_D4_PORT PORTD
#define LCD_D4_PIN	PIND5
